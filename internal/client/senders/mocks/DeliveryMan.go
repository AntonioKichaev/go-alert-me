...
// DeliveryMetrics provides a mock function with given fields: _a0
func (_m *DeliveryMan) DeliveryMetricsJSON(_a0 []metrics.Metrics) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func([]metrics.Metrics) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
// DeliveryMan_DeliveryMetrics_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeliveryMetricsJSON'
type DeliveryMan_DeliveryMetrics_Call struct {
	*mock.Call
}

// DeliveryMetrics is a helper method to define mock.On call
//   - _a0 []metrics.Metrics
func (_e *DeliveryMan_Expecter) DeliveryMetrics(_a0 interface{}) *DeliveryMan_DeliveryMetrics_Call {
	return &DeliveryMan_DeliveryMetrics_Call{Call: _e.mock.On("DeliveryMetricsJSON", _a0)}
}

func (_c *DeliveryMan_DeliveryMetrics_Call) Run(run func(_a0 []metrics.Metrics)) *DeliveryMan_DeliveryMetrics_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]metrics.Metrics))
	})
	return _c
}

func (_c *DeliveryMan_DeliveryMetrics_Call) Return(_a0 error) *DeliveryMan_DeliveryMetrics_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *DeliveryMan_DeliveryMetrics_Call) RunAndReturn(run func([]metrics.Metrics) error) *DeliveryMan_DeliveryMetrics_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewDeliveryMan(t interface {
	mock.TestingT
	Cleanup(func())
}) *DeliveryMan {
	mock := &DeliveryMan{}
