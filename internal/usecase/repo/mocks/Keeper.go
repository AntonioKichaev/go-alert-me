...
func (_m *Keeper) AddCounter(counter *metrics2.Counter) (*metrics2.Counter, error) {
	ret := _m.Called(counter)

	var r0 *metrics2.Counter
	var r1 error
	if rf, ok := ret.Get(0).(func(*metrics2.Counter) (*metrics2.Counter, error)); ok {
		return rf(counter)
	}
	if rf, ok := ret.Get(0).(func(*metrics2.Counter) *metrics2.Counter); ok {
		r0 = rf(counter)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*metrics2.Counter) error); ok {
		r1 = rf(counter)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Keeper_AddCounter_Call) Run(run func(counter *metrics2.Counter)) *Keeper_AddCounter_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*metrics2.Counter))
	})
	return _c
}

func (_c *Keeper_AddCounter_Call) Return(_a0 *metrics2.Counter, _a1 error) *Keeper_AddCounter_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Keeper_AddCounter_Call) RunAndReturn(run func(*metrics2.Counter) (*metrics2.Counter, error)) *Keeper_AddCounter_Call {
	_c.Call.Return(run)
	return _c
}

// GetCounter provides a mock function with given fields: name
func (_m *Keeper) GetCounter(name string) (*metrics2.Counter, error) {
	ret := _m.Called(name)

	var r0 *metrics2.Counter
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*metrics2.Counter, error)); ok {
		return rf(name)
	}
	if rf, ok := ret.Get(0).(func(string) *metrics2.Counter); ok {
		r0 = rf(name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*metrics2.Counter)
...
func (_c *Keeper_GetCounter_Call) Return(_a0 *metrics2.Counter, _a1 error) *Keeper_GetCounter_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Keeper_GetCounter_Call) RunAndReturn(run func(string) (*metrics2.Counter, error)) *Keeper_GetCounter_Call {
	_c.Call.Return(run)
	return _c
}

// GetGauge provides a mock function with given fields: name
func (_m *Keeper) GetGauge(name string) (*metrics2.Gauge, error) {
	ret := _m.Called(name)

	var r0 *metrics2.Gauge
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*metrics2.Gauge, error)); ok {
		return rf(name)
	}
	if rf, ok := ret.Get(0).(func(string) *metrics2.Gauge); ok {
		r0 = rf(name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*metrics2.Gauge)
		}
	}
...
func (_c *Keeper_GetGauge_Call) Return(_a0 *metrics2.Gauge, _a1 error) *Keeper_GetGauge_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Keeper_GetGauge_Call) RunAndReturn(run func(string) (*metrics2.Gauge, error)) *Keeper_GetGauge_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Keeper) SetGauge(gauge *metrics2.Gauge) (*metrics2.Gauge, error) {
	ret := _m.Called(gauge)

	var r0 *metrics2.Gauge
	var r1 error
	if rf, ok := ret.Get(0).(func(*metrics2.Gauge) (*metrics2.Gauge, error)); ok {
		return rf(gauge)
	}
	if rf, ok := ret.Get(0).(func(*metrics2.Gauge) *metrics2.Gauge); ok {
		r0 = rf(gauge)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*metrics2.Gauge)
	...
	if rf, ok := ret.Get(1).(func(*metrics2.Gauge) error); ok {
		r1 = rf(gauge)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Keeper_SetGauge_Call) Run(run func(gauge *metrics2.Gauge)) *Keeper_SetGauge_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*metrics2.Gauge))
	})
	return _c
}

func (_c *Keeper_SetGauge_Call) Return(_a0 *metrics2.Gauge, _a1 error) *Keeper_SetGauge_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Keeper_SetGauge_Call) RunAndReturn(run func(*metrics2.Gauge) (*metrics2.Gauge, error)) *Keeper_SetGauge_Call {
	_c.Call.Return(run)
	return _c
}
